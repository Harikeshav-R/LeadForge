...
import type {EmailContent, Lead} from '../types';
...
export function LeadsTable({leads}: LeadsTableProps) {
    ...
    const validateAndCleanEmailContent = (content: EmailContent): {
        valid: boolean;
        error?: string;
        cleaned?: EmailContent
    } => {
        ...
        if (toEmails.length === 0) {
            return {
                valid: false,
                error: 'At least one recipient is required. Please add a valid email address in the "To" field.'
            };
        }
        ...
        return (
            <Card className="text-center py-20 px-8">
                ...
                <
                    Building2 className
                                  =
                                  "w-16 h-16 text-muted-foreground mx-auto mb-8"/>
                <h3 className
                        =
                        "text-xl font-semibold text-foreground mb-4">No leads yet</h3>
                                ...
                                <TableRow key={lead.id} className="hover:bg-muted/30 transition-colors">
                                    <TableCell className
                                        ...
                                        <div className
                                            ...
                                            <div className
                                                     =
                                                     "text-sm font-semibold text-foreground leading-6">
                                                {
                                                    lead.name
                                                }
                                            </div>
                                            <div
                                                className="text-xs text-muted-foreground leading-5">{lead.address}</div>
                                            {
                                                lead.category && (
                                                    <div
                                                        className="text-xs text-muted-foreground leading-5">{lead.category}</div>
                                                )
                                            }
                                            {
                                                lead.rating && (
                                    ...
                                    <TableCell className="py-6">
                                        <div className="flex flex-col gap-2">
                                            {lead.phone_number && (
                                                <div
                                                    className="flex items-center gap-2 text-xs text-muted-foreground leading-5">
                                        ...
                                        <div className="flex flex-col gap-3">
                                            ...
                                            {lead.emails.length > 0 && (
                                                <div className="flex flex-col gap-2">
                                                                ...
                                                                {emailState?.error && !emailState?.loading && (
                                                                    <div
                                                                        ...
                                                                        <div className="flex items-start gap-2">
                                                                            ...
                                                                            <div className="flex-1">
                                                                                <p className="text-sm font-medium text-red-900">Error
                                                                                    Creating Draft</p>
                                                    ...
                                                    {leadState?.emailDraft.showPreview && leadState?.emailDraft.draftContent && (
                                                        <div
                                                            className="mt-2 border border-gray-200 rounded-lg bg-white shadow-lg w-full max-w-6xl">
                                                            {/* Preview Header */}
                                                            <div
                                                                className="flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50">
                                                                <h4 className="text-lg font-semibold text-gray-900">Email
                                                                    Preview</h4>
                                                                <Button
                                                                    variant="secondary"
                                                                    size="sm"
                                                            ...
                                                            <div className="p-4 space-y-4">
                                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                                    <div>
                                                                        <div
                                                                            className="text-sm font-medium text-gray-700 mb-1">To:
                                                                        </div>
                                                                        <input
                                                                            type="email"
                                                                    ...
                                                                    <div>
                                                                        <div
                                                                            className="text-sm font-medium text-gray-700 mb-1">From:
                                                                        </div>
                                                                        <input
                                                                            type="email"
                                                                ...
                                                                <div>
                                                                    <div
                                                                        className="text-sm font-medium text-gray-700 mb-1">Subject:
                                                                    </div>
                                                                    <input
                                                                        type="text"
                                                                ...
                                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                                    <div>
                                                                        <div
                                                                            className="text-sm font-medium text-gray-700 mb-1">CC
                                                                            (Optional):
                                                                        </div>
                                                                        <input
                                                                            type="email"
                                                                    ...
                                                                    <div>
                                                                        <div
                                                                            className="text-sm font-medium text-gray-700 mb-1">BCC
                                                                            (Optional):
                                                                        </div>
                                                                        <input
                                                                            type="email"
                                                                ...
                                                                <div>
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            className="text-sm font-medium text-gray-700">Message:
                                                                        </div>
                                                                        <Button
                                                                            variant="secondary"
                                                                            size="sm"
                                            ...
                                            <div className="flex flex-col gap-2">
                                                {(() => {
                                                    ...
                                                    if (buildState?.success && buildState?.websiteZip && stage === 'built' && !buildState?.deployedUrl) {
                                                        return (
                                                            <>
                                                                <div
                                                                    className="flex items-center gap-2 text-sm text-blue-700 bg-blue-50 px-3 py-2 rounded-lg">
                                                                    <CheckCircle className="w-4 h-4"/>
                                                                    Website Built
                                                                </div>
                                                                <div className="flex flex-col gap-2">
                                                ...
                                                {leadState?.websiteBuild.error && (
                                                    <div className="flex flex-col gap-2">
                                                        <div
                                                            className="text-xs text-red-600 bg-red-50 px-2 py-1 rounded max-w-xs">
                                                            {leadState.websiteBuild.error}
                                                        </div>
                                                        <Button
                                                            variant="secondary"
