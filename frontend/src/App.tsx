...
import type {CampaignData, Lead} from './types';
                            ...
                            <div className="space-y-16 fade-in-up">
                                ...
                                <div className="text-center px-4">
                                    ...
                                    <p className="text-sm text-muted-foreground max-w-3xl mx-auto leading-6">
                                        Found <Badge variant="secondary"
                                                     className="mx-1">{campaignData.leads.length}</Badge> businesses
                                        for: "{campaignData.searchQuery}"
                                    </p>
                                </div>
                                ...
                                <div className="px-4">
                                    ...
                                    <div className="bg-muted/50 rounded-xl p-12 border border-dashed border-border">
                                        ...
                                        <div className="text-center">
                                            <svg className="w-16 h-16 text-muted-foreground mx-auto mb-6" fill="none"
                                                 stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                                                      d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                            </svg>
                                            <h4 className="text-lg font-semibold text-foreground mb-3">Business
                                                Leads</h4>
                                            <p className="text-muted-foreground max-w-md mx-auto">Detailed business
                                                information with contact details will appear here</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="px-4">
                                    ...
                                    <div className="bg-muted/50 rounded-xl p-12 border border-dashed border-border">
                                        ...
                                        <div className="text-center">
                                            ...
                                            <h4 className="text-lg font-semibold text-foreground mb-3">Contact
                                                Details</h4>
                                            <p className="text-muted-foreground max-w-md mx-auto">Email addresses, phone
                                                numbers, and social media links</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="px-4">
                                    ...
                                    <div className="bg-muted/50 rounded-xl p-12 border border-dashed border-border">
                                        <div className="text-center">
                                            ...
                                            <p className="text-muted-foreground max-w-md mx-auto">Website reviews,
                                                business ratings, and market insights</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section className="text-center py-20 px-4">
                        ...
                        <div className="max-w-2xl mx-auto">
                            ...
                            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
                                Found {campaignData.leads.length} businesses for "{campaignData.searchQuery}". Scroll
                                down to view the results.
                            </p>
